...
//---------------------------------------------------------
// Constructor: Initializes the function list with default operations
Manager::Manager() {
...
//---------------------------------------------------------
// Destructor: Nothing to clean up manually (smart pointers handle memory)
Manager::~Manager() {
}

//---------------------------------------------------------
// Main loop: Handles user input and executes commands
void Manager::run()
{
    while (1)
    {
        // Print currently available functions
        ...
        // Evaluate a function with user-provided matrices
        if (input == "eval")
        {
            int func;
            int matrixSize;
        ...
        // Create addition of two existing functions
        else if (input == "add")
        {
            int func1, func2;
            std::cin >> func1 >> func2;
        ...
        // Create subtraction of two existing functions
        else if (input == "sub")
        {
            int func1, func2;
            std::cin >> func1 >> func2;
        ...
        // Create composition of two existing functions
        else if (input == "comp")
        {
            int func1, func2;
            std::cin >> func1 >> func2;
        ...
        // Clear input matrices for the next operation
        m_matrices.clear();
    }
}

//---------------------------------------------------------
// Prints the list of current functions by index
...
//---------------------------------------------------------
// Prints a message asking user to enter a number of matrices
...
//---------------------------------------------------------
// Reads matrices from user input
...
//---------------------------------------------------------
// Prints a help menu with available commands
void Manager::printHelp()
{
    ...
    std::cout << "  on all needed nªn matrices (that will be prompted)" << std::endl;
